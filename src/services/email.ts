...
async function createTransporter() {
  const oauth2Client = new OAuth2(
    process.env.GMAIL_CLIENT_ID_GMAIL!,
    process.env.GMAIL_CLIENT_SECRET_GMAIL!,
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      ...
      clientId: process.env.GMAIL_CLIENT_ID_GMAIL!,
      clientSecret: process.env.GMAIL_CLIENT_SECRET_GMAIL!,
